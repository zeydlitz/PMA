...
class Region(models.Model):
    ...
    nameregion = models.CharField(db_column='NameRegion', max_length=30)  # Field name made lowercase.
...
class Registar(models.Model):
    registarid = models.IntegerField(db_column='RegistarID', primary_key=True)  # Field name made lowercase.
    sensorid = models.ForeignKey('Sensor', models.DO_NOTHING, db_column='SensorID')  # Field name made lowercase.
